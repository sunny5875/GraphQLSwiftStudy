...
/// <em>NOTE:</em> Delegate methods implemented here are not documented inline because
...
SWIFT_CLASS("_TtC6Apollo16URLSessionClient")
@interface URLSessionClient : NSObject <NSURLSessionDataDelegate>
...
- (void)URLSession:(NSURLSession * _Nonnull)session dataTask:(NSURLSessionDataTask * _Nonnull)dataTask didBecomeStreamTask:(NSURLSessionStreamTask * _Nonnull)streamTask;
